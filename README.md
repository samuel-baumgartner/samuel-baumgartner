...
- Live productivity system (phone + desktop + browser + widget): [samuelbaumgartner.ch/personal/dashboard](https://www.samuelbaumgartner.ch/personal/dashboard)

### Pinned

- **saemi** — cross-device productivity system I use daily (Next.js + Prisma + Chrome extension + Android widget).
- **Start-Hack-26** — Flora AI, 2nd place at StartHack 2026.
